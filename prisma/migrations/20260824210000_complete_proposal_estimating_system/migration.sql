...
-- Generated locally via Prisma schema diff against current Production schema.
-- Pending migration only: do not apply until approved for Production.
...
-- Reconcile legacy Production WC default from 17.5% to the approved estimator value.
-- GL, overhead, markup, and labor-rate settings are intentionally unchanged.
UPDATE "Config"
